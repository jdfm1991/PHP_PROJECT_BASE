...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Modulo de Cuenta De Ingreos <br> .::Creacion y Modificacion::.</h1>
          <div class="card mb-2">
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-body">
              <div id="module_body">
                <table id="income_account_table" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      <th>Cuenta</th>
                      <th>Codigo</th>
  ...
  ?>
  <script src="cuentaingresos.js"></script>
</body>
